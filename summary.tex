...
\begin{frame}{常见 \LaTeX 困惑}
  \begin{itemize}
    ...
    \item \alert{参考文献} 推荐使用 \BibTeX 或者 Bib\LaTeX（视模板而定），也可以手写 \cmd{bibitem} \url{https://github.com/hushidong/biblatex-gb7714-2015}
  \end{itemize}
\end{frame}
  ...
  \begin{columns}[c]
    \begin{column}{.45\textwidth}
      \begin{itemize}
        \item BBS
          \begin{itemize}
            \item 水木社区 TeX 版 （不活跃）\url{http://www.newsmth.net/nForum/board/TeX}
            \item \sout{\CTeX 社区} （已关闭） \url{http://bbs.ctex.org/}
            \item 转移到 GitHub 的 \CTeX 社区 \url{https://github.com/CTeX-org/forum}
          \end{itemize}
...
\begin{frame}{你也可以帮助}
  \begin{itemize}
    \item 错误反馈、改进建议：GitHub Issues \url{https://github.com/tuna/thulib-latex-talk/issues}
